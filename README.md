...
![Version](https://img.shields.io/badge/version-v0.11.1--alpha--1-blue)
 ![License](https://img.shields.io/badge/license-MIT-green) ![Tests](https://img.shields.io/badge/tests-540%20passing-brightgreen) ![AppDaemon](https://img.shields.io/badge/AppDaemon-4.x-orange)
...
> **Status:** v0.11.1-alpha-1 — MAE midnight-jump fix + EV energy sensor correction.
